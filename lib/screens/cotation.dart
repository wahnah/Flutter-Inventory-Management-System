...
class Cotation extends StatefulWidget {
  @override
  _CotationState createState() => _CotationState();
}
...
String generateUniqueInvoiceNumber() {
  ...
  final outputFile = File('${output.path}/cotation.pdf');
  ...
  Future<void> sendInvoice(File invoice) async {
    final Email email = Email(
      body: 'Please find the attached cotation.',
      subject: 'cotation',
