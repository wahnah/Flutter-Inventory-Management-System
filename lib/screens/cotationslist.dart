...
class cotationslist extends StatefulWidget {
  @override
  _cotationslistState createState() => _cotationslistState();
}

class _cotationslistState extends State<cotationslist> {
...
List<String> searchResults = [];
  ...
  Future<File> loadFirebase(String url) async {
    try {
      final refPDF = firebase_storage.FirebaseStorage.instance.ref('cotations').child(url);
  ...
  Future<void> listExample() async {
    firebase_storage.ListResult result =
        await firebase_storage.FirebaseStorage.instance.ref().child('cotations').listAll();
