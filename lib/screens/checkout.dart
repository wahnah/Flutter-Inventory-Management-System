          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                ValueListenableBuilder<PaymentOption>(
                  valueListenable: _selectedPaymentOptionNotifier,
                  builder: (BuildContext context, PaymentOption value, Widget child) {
                    return Container(
                      child: Column(
                        children: [
                          ...
                          DropdownButton<PaymentOption>(
                            ...
                            onChanged: (PaymentOption newValue) {
                              _selectedPaymentOptionNotifier.value = newValue;
                            },
                            items: <PaymentOption>[
                              PaymentOption.cash,
                              PaymentOption.card,
...
String generateUniqueInvoiceNumber() {
  ...
  final outputFile = File('${output.path}/receipt.pdf');
  ...
  Future<void> sendInvoice(File invoice) async {
    final Email email = Email(
      body: 'Please find the attached Purchase Receipt.',
