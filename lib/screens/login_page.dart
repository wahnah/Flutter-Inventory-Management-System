      ...
      AuthUtil.signInUser(
        ...
        switch (e.code) {
          ...
          case 'ERROR_EMAIL_ALREADY_IN_USE':
            authError = "You have an account already, please sign in";
            break;
          default:
            authError = 'Error';
            break;
                ...
                children: [
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        borderSide: BorderSide(color: Color(0xFF455A64), width: 2.0),
                        borderRadius: BorderRadius.all(Radius.circular(32.0)),
                      ),
                    ),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        try {
                          AuthUtil.resetpassword(emailController.text);
                          print("Password reset email sent");
                          _warning = "A password reset link has been sent! Check Your Email";
